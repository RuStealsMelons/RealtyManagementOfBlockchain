...
const navList = ref([
    ...
    {title: "维修审核", router: "/index/audit", img: "https://pic1.afdiancdn.com/user/27f7cea2370d11e8ae8852540025c377/common/1a4490c31e402d1f5e95109d0f7cb85e_w500_h500_s33.jpg?imageView2/1"}
])
    ...
    <div class="bg">
        <div class="nr">
            <div class="navs">
                ...
                <el-button v-for="(value, index) in navList" style="height: 60px;" @click="router.push(value.router)" :key="index" size="large" class="nav" plain> 
